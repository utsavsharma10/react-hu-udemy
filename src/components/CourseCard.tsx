...
const CourseCard = ({ item, handleClick }: any) => {
  ...
  return (
    <Card
      sx={{ mb: 1.5, display: "flex", justifyContent: "space-evenly" }}
    ...
    >
      ...
      />
      <CardContent
        sx={{ flexBasis: "100%", display: "flex", alignItems: "center" }}
      >
        <Typography
          display="inline"
          sx={{ fontSize: 14, fontWeight: "bold", width: "40%" }}
        >
          {title}
          <p>
            <Button
            ...
            <Button size="small" href="#" style={buttonStyle}>
              {tag2}
            </Button>
          </p>
        </Typography>
        ...
        <Typography
          display="inline"
          sx={{ fontSize: 18, width: "15%", fontWeight: "bolder" }}
        >
          Rs {price}/-
        </Typography>
        <Typography
